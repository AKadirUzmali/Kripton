...
namespace core::virbase::socket
{
    ...
    class AccessPolicy final
    {
        ...
        public:
            ...
            bool isEnablePassword() const noexcept;
    ...
    /**
     * @brief [Public] Is Enable Password
     * 
     * Şifre kontrolünün aktif olup olmadığını
     * tutan atomik değişkenin değerini döndürecek
     * 
     * @return bool
     */
    bool AccessPolicy::isEnablePassword(
    ) const noexcept
    {
        return this->require_password.load();
    }
